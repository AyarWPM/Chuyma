...
Documentacion: https://github.com/AyarWPM/Chuyma/wiki"
    ...
    return buttonbox(msg, ttl, image="imagenes/logo.png", choices=opciones)
...
favor no utilizar acentos ni la letra ñ, el programa explotaría.",
    ...
    crearElementos()
    msgbox("Felicidades!\n===========\n\n\
El primer elemento creado a sido asociado según el Principio de Antagonismo al \
segundo elemento creado. Ya se ha generado el primer nivel de la tabla de \
...
def mostrarElementos():
    ...
    while 1:
        ...
        if seleccion1:
            ...
            #if seleccion2 == 1:
                #if constructores.diccElem[seleccion1].estadoC is None:
                    #asignarAnti(seleccion1)
                #else:
                    #msgbox("Este elemento ya tiene un elemento asociado.",
                        #"Problema...")
            if seleccion2 == 1:
